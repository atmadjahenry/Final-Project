...
def result():
    if request.method == 'POST':
        ...
        if 850.0 >= int(user['credit score']) >= 720.0 :
        ...
        elif 629.0 >= int(user['credit score']) >= 300.0 :
        ...
        if prediksi < 0.499394525800627:
            hasil = 'Congratulations! Your loan IS APPROVED.'
        else:
            hasil = 'Sorry, your loan IS NOT APPROVED'
